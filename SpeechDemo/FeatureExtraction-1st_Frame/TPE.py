...
def HGabor(input):
    ...
    try:
        ...
        Gabor_Path = 'C:/Users/Yan.Xu/Desktop/SpeechDemo/SpeechDemo/FeatureExtraction/TPEH.jpg'
...
def TPE(TPEPath,b,shotname,picturepathF,mouth_centroid_xF, mouth_centroid_yF,ROI_mouthF,widthGF,heightGF):
    ...
    search_spaceH = {
        ...
        "Hkernel_size": hyperopt.hp.quniform('Hkernel_size', 14, 20, 1),
        "Hwavelength": hyperopt.hp.quniform('Hwavelength', 14, 20, 1),
    ...
    search_spaceH['Hgamma'] = hyperopt.hp.quniform('Hgamma', Hgamma_min, 1, 0.1)
