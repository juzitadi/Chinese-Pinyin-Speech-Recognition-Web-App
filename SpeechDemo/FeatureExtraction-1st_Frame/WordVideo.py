            ...
            while (cap.isOpened()):  # cv2.VideoCapture.isOpened()
                ...
                if ret == True:
                    ...
                    while True:
                        try:
                            if i == 1:
                                HGamma, HKernelSize, HSig, HWavelength = TPE.TPE(TPEPath, i, folder_name, picturepath,
                                                                                 mouth_centroid_x,
                            ...
                            value = Features.Features(mouth_centroid_x, mouth_centroid_y, i, folder_name, Gabor_Path,
